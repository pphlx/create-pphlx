...
`);
  ...
  if (!fs.existsSync(pphlxConfigJsonPath)) {
    const pphlxConfig = {
      srcDir: 'src',
      outDir: 'dist',
      cssOut: 'dist/assets/app.css',
      jsOut: 'dist/assets/app.js',
...
`;
  ...
  // 5. Scaffold src/layouts/ Layout.pphx
...
$_title = !empty($title) ? $title : 'Welcome to PPHLX!';
|}
<!DOCTYPE html>
<html lang="en">
<head>
...
`;
    ...
    console.log(`  ${ANSI.green}✓${ANSI.reset} Created src/layouts/Layout.pphx`);
  }

  // 6. Scaffold src/components/ directory
  const componentsDir = path.join(projectDir, 'src', 'components');
  if (!fs.existsSync(componentsDir)) {
    fs.mkdirSync(componentsDir, { recursive: true });
    console.log(`  ${ANSI.green}✓${ANSI.reset} Created src/components/ directory`);
  }

  // 7. Scaffold src/index.pphx
  const indexPath = path.join(projectDir, 'src', 'index.pphx');
...
`;
    ...
    console.log(`  ${ANSI.green}✓${ANSI.reset} Created src/index.pphx template`);
  }

  // 8. Scaffold src/assets/pphlx.svg
  const assetsDir = path.join(projectDir, 'src', 'assets');
  if (!fs.existsSync(assetsDir)) {
    fs.mkdirSync(assetsDir, { recursive: true });
  }
  const svgPath = path.join(assetsDir, 'pphlx.svg');
  if (!fs.existsSync(svgPath)) {
    const svgContent = `<svg width="115" height="40" viewBox="0 0 460 160" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="logo-svg">
  ...
  <path d="M46.829 99.5551C46.3154 99.2555 46.187 99.9297 46.187 100.304C45.9195 102.23 45.759 106.35 48.0595 112.181C50.3601 118.012 56.7266 120.848 59.9366 121.276C63.1465 121.704 69.46 121.009 70.4231 120.635C71.3862 120.26 71.172 119.724 70.7976 119.404C70.4231 119.083 47.471 99.9297 46.829 99.5551Z" fill="#13151A"></path>
    ...
    console.log(`  ${ANSI.green}✓${ANSI.reset} Created src/assets/pphlx.svg`);
  }

  // 9. Scaffold public/favicon.svg & public/favicon.ico
  const publicDir = path.join(projectDir, 'public');
  if (!fs.existsSync(publicDir)) {
    fs.mkdirSync(publicDir, { recursive: true });
  }
  const favSvgPath = path.join(publicDir, 'favicon.svg');
  if (!fs.existsSync(favSvgPath)) {
    const favSvgContent = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
  ...
  <path d="M25 75V25H45C55 25 60 30 60 38C60 46 55 51 45 51H37V75H25ZM37 40H44C48 40 50 38 50 35C50 32 48 30 44 30H37V40Z" fill="#FFFFFF"/>
    ...
    fs.writeFileSync(favSvgPath, favSvgContent, 'utf8');
    console.log(`  ${ANSI.green}✓${ANSI.reset} Created public/favicon.svg`);
  }

  const favIcoPath = path.join(publicDir, 'favicon.ico');
  if (!fs.existsSync(favIcoPath)) {
    const icoB64 = "";
    const icoBuffer = Buffer.from(icoB64, 'base64');
    fs.writeFileSync(favIcoPath, icoBuffer);
    console.log(`  ${ANSI.green}✓${ANSI.reset} Created public/favicon.ico`);
  }

  // 10. Scaffold README.md
  const readmePath = path.join(projectDir, 'README.md');
  if (!fs.existsSync(readmePath)) {
    const readmeContent = `# 🚀 Welcome to PPHLX
...
`;
    ...
    console.log(`  ${ANSI.green}✓${ANSI.reset} Created README.md`);
  }

  // 11. Scaffold .gitignore
